  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-3xl p-12 text-center border border-neutral-200 shadow-sm max-w-3xl mx-auto mt-12">
        ...
        <h1 className="text-4xl font-black text-neutral-900 mb-4 tracking-tight">Technical Audit</h1>
        <p className="text-xl text-neutral-500 mb-8">
          Advanced technical SEO crawling, log file analysis, and core web vitals monitoring are coming soon.
        </p>
