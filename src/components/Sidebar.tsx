...
export default function Sidebar() {
  ...
  return (
    <aside className="w-72 bg-white border-r border-neutral-200 min-h-[calc(100vh-64px)] hidden lg:flex flex-col sticky top-16 overflow-y-auto custom-scrollbar">
